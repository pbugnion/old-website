...
class IPythonNB(BaseReader):
    ...
    def read(self, filepath):
        ...
        exporter = HTMLExporter(config=config, template_file='custom.tpl',
        ...
        parser = HTMLReader._HTMLParser(self.settings, filename)
        parser.feed(content)
        parser.close()
        body = parser.body
...
#                       'code', 'pre', 'div.text_cell_render','.nav', '.container', '.page-header']
