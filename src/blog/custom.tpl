...
{% from 'add_classes.tpl' import add_blog_input_classes %}


{% block codecell %}
<div class="cell border-box-sizing code_cell rendered {{ add_blog_input_classes(cell) }}">
{{ super() }}
</div>
{%- endblock codecell %}
...
{{ cell.source | highlight2html(language=resources.get('language'), metadata=cell.metadata) }}
</div>
</div>
{%- endblock input %}
